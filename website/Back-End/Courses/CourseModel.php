...
class Course extends domain
{
    ...
    function __construct()
    {
        ...
        $FileName = "C:\wamp64\www\website\Back-End\Courses\Courses.txt";
        $Separetor = "~";
    ...
    function ListCourses()
    {
        ...
        while (!feof($myfile)) {
            ...
            if ($ArrayLine[0] != "") {
                $MyReturn[$i] = $this->GetCourse($ArrayLine[0]);
            }
            $i++;
        }
        fclose($myfile);
    ...
    function Store()
    {
        ...
        $this->record = $this->id . "~" . $this->Name . "~" . $this->Code . "~" . $this->Day . "~" . $this->Time;
    ...
    function update($FileManagerObj)
    {
        ...
        $record = $this->id . "~" . $this->Name . "~" . $this->Code . "~" . $this->Day . "~" . $this->Time;
